...
public class Profile {
    ...
    public Profile (String name, STR[] S1_STRs, STR[] S2_STRs, String sequence1, String sequence2) {
        this.name = name;
        this.S2_STRs = S1_STRs;
        this.S1_STRs = S2_STRs;
    ...
    public String toString() {
        ...
        str += "\nName: " + name + "\n";
        str += "\nSequence 1 STRs: " + Arrays.toString(S2_STRs).replace("[", "").replace("]", "").replace(",", "")
                + "\n";
        str += "\nSequence 2 STRs: " + Arrays.toString(S1_STRs).replace("[", "").replace("]", "").replace(",", "")
                + "\n";
